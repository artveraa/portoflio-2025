  ...
  return (
    <div className="images-wrapper relative w-full border border-red-500 h-[30vh] flex justify-center items-center ">
      <Image
        ...
        width={918}
        height={928}
        className="z-10  border-[7px] border-b-[55px] border-light w-[70%] md:w-[30%] translate-y-[-35%] opacity-0"
      />
      ...
      <Image
        ...
        width={918}
        height={928}
        className="-z-1 absolute opacity-0 border-[7px] border-b-[55px] border-light w-[70%] md:w-[30%] translate-y-[-60%]"
      />
      ...
      <Image
        ...
        width={918}
        height={928}
        className="-z-1 absolute opacity-0 border-[7px] border-b-[55px] border-light w-[70%] md:w-[30%] translate-y-[-40%]"
      />
    </div>
  );
};
